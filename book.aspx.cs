...
public partial class book : System.Web.UI.Page
{
    ...
    protected void Button4_Click(object sender, EventArgs e)
    {
        ...
        conn1();
        string SQ = "select * from books where ISBN='" + TextBox4.Text.ToString() + "'";
    ...
    {
        conn1();
        string UQ = "update books set BookName='" + TextBox1.Text + "',Catagory='" + TextBox2.Text + "',Author='" + TextBox3.Text + "',Price='" + TextBox5.Text + "' where ISBN='" + TextBox4.Text.ToString() + "'";
