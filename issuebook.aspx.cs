...
public partial class issuebook : System.Web.UI.Page
{
    ...
    {
        conn1();
        string insertQuery = "insert into issuebook (StudentId,ISBN,IssueDate,ReturnDate,Fine) values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "')";
        SqlCommand cmd = new SqlCommand(insertQuery, cnn);
        cmd.ExecuteNonQuery();
        Response.Write("<h5>" + " Your Details Sucessfully Registered.. " + "</h5>");
        TextBox1.Text = " ";
        TextBox2.Text = " ";
        TextBox3.Text = " ";
        TextBox4.Text = " ";
    ...
    {
        Response.Redirect("issueboodelete.aspx");
    }
    protected void Button3_Click(object sender, EventArgs e)
    {
        Response.Redirect("issuebookdelete.aspx");
    }
    protected void Button2_Click(object sender, EventArgs e)
    {
        Response.Redirect("issuebookupdate.aspx");
    }
}