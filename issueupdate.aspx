<%@ Page Language="C#" AutoEventWireup="true" CodeFile="issueupdate.aspx.cs" Inherits="issueupdate" %>
   ...
   <div class="item1">
    ...
    <div class="item2">
     <asp:Image ID="Image3" runat="server" Height="40px" 
      ...
      <asp:LinkButton ID="LinkButton2" runat="server" 
            PostBackUrl="~/StudentDetail.aspx">Issue Detail</asp:LinkButton>
    </div>
    <div class="item3">
     <asp:Image ID="Image4" runat="server" Height="40px" 
            ...
            Width="50px" />
     <asp:LinkButton ID="LinkButton3" runat="server" PostBackUrl="~/booksdetails.aspx">Issue Update</asp:LinkButton>
    </div>
    <div class="item4">
     <asp:Image ID="Image5" runat="server" Height="40px" 
                ImageUrl="image/25.png"  Width="50px" />
     <asp:LinkButton ID="LinkButton4" runat="server" PostBackUrl="~/issuebook.aspx">Issue Delete</asp:LinkButton>
    </div>
        </asp:Panel>
     <div class="item5">
    ...
    <div id="section-2">
        <asp:Image ID="Image6" runat="server" 
            ImageUrl="image/28.gif"  />
        <asp:Label ID="Label3" runat="server" Text="Student ID"></asp:Label>
        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
         <asp:Label ID="Label4" runat="server" Text="Book ISBN"></asp:Label>
        ...
        <asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
         <asp:Label ID="Label7" runat="server" Text="Fine"></asp:Label>
