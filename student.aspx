   ...
   <div class="item1">
    ...
    <div class="item3">
     <asp:Image ID="Image4" runat="server" Height="40px" 
            ...
            Width="50px" />
     <asp:LinkButton ID="LinkButton3" runat="server" PostBackUrl="~/booksdetails.aspx">Books Register</asp:LinkButton>
    </div>
    <div class="item4">
     <asp:Image ID="Image5" runat="server" Height="40px" 
                ImageUrl="image/25.png"  Width="50px" />
     <asp:LinkButton ID="LinkButton4" runat="server" PostBackUrl="~/issuebook.aspx">Issue Books</asp:LinkButton>
    </div>
        </asp:Panel>
     <div class="item5">
