<%@ Page Language="C#" AutoEventWireup="true" CodeFile="studentdelete.aspx.cs" Inherits="studentdelete" %>
   ...
   <div class="item1">
    ...
    <div class="item2">
     <asp:Image ID="Image3" runat="server" Height="40px" 
      ...
      <asp:LinkButton ID="LinkButton2" runat="server" 
            PostBackUrl="~/StudentDetail.aspx">Student Detail</asp:LinkButton>
    </div>
    <div class="item3">
     <asp:Image ID="Image4" runat="server" Height="40px" 
            ...
            Width="50px" />
     <asp:LinkButton ID="LinkButton3" runat="server" PostBackUrl="~/booksdetails.aspx">Student Update</asp:LinkButton>
    </div>
    <div class="item4">
     <asp:Image ID="Image5" runat="server" Height="40px" 
                ImageUrl="image/25.png"  Width="50px" />
     <asp:LinkButton ID="LinkButton4" runat="server" PostBackUrl="~/issuebook.aspx">student Delete</asp:LinkButton>
    </div>
        </asp:Panel>
     <div class="item5">
    ...
    <div id="section-2">
        ...
        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
         <asp:Label ID="Label4" runat="server" Text="Full_Name"></asp:Label>
        <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
        <asp:Label ID="Label5" runat="server" Text="Email"></asp:Label>
        <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
        <asp:Label ID="Label6" runat="server" Text="Mobile_No"></asp:Label>
